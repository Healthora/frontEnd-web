...
const Signin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = await doctorService.signIn(formData);
                ...
                <div className="hidden lg:flex flex-col gap-8">
                    ...
                    <div className="space-y-6">
                        <h1 className="text-5xl font-black text-gray-900 leading-tight">
                            Bienvenue sur votre
                            <span className="bg-linear-to-r from-sky-600 to-indigo-600 bg-clip-text text-transparent"> Plateforme Médicale</span>
                        </h1>
